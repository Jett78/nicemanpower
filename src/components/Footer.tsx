  ...
  return (
    ...
    >
      <div className="w-11/12 relative lg:w-8/12 mx-auto flex flex-col">
        <div className="w-full lg:h-[30vh] flex justify-center items-center bg-zinc-100 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]  rounded-3xl">
          <div className="w-full p-5 lg:p-[5rem] gap-4 text-zinc-800  h-full flex flex-col lg:flex-row justify-between  items-center">
            <div className="w-full flex flex-col">
              <h1 className="text-[8vw] md:text-[4vw] hero font-medium lg:text-[3vw] leading-normal">
                Reach out
              </h1>
              <h1 className="text-[4vw] md:text-[4vw] lg:text-[1vw] text-zinc-600 leading-normal">
                info@nicerecruitment.org
              </h1>
            </div>

            <p className="w-full lg:w-[50%] text-start lg:text-end text-zinc-700 text-[3.5vw] lg:text-[1vw]">
        ...
        <div className="w-full mx-auto  py-[5vh] lg:grid-cols-2 grid gap-x-5 gap-y-5">
          ...
          <img className="w-[15vw] lg:w-[6vw]" src="/public/logo/nice-logo.png" alt="" />
