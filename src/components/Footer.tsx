  ...
  return (
    ...
    >
      <div className="w-11/12 relative lg:w-8/12 mx-auto flex flex-col">
        <div className="w-full h-[30vh] flex justify-center items-center bg-gray-100 rounded-3xl">
          <div className="w-full p-[2rem] text-tertiary-800 pb-4 flex justify-between  items-center">
            <div className=" flex flex-col">
              <h1 className="text-[5vw] md:text-[4vw] lg:text-[3vw] leading-normal">
                Reach out
              </h1>
              <h1 className="text-[5vw] md:text-[4vw] lg:text-[1vw] text-tertiary-700 leading-normal">
                info@nicerecruitment.org
              </h1>
            </div>

            <p className="w-[50%] text-end text-tertiary-700 text-[1.2vw]">
        ...
        <div className="w-full mx-auto  py-[5vh] grid-cols-2 grid gap-x-5 gap-y-5">
          ...
          <div className="flex w-full text-nowrap  text-[3vw] md:text-[2.5vw] lg:text-[0.9vw] text-tertiary-700 gap-5 justify-end items-center font-medium">
