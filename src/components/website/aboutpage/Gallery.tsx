...
export default function Gallery({}: Props) {
  ...
  return (
    <div className="w-full py-[2rem]">
      ...
      <p className="py-4 text-[3.5vw] lg:text-[1.2vw] text-zinc-700 text-start lg:text-center lg:w-8/12 mx-auto">Cherish the moments with us with the collection of our memories.</p>
