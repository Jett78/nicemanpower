...
export default function CoreValues({}: Props) {
  ...
  return (
    <div className="py-[2rem] w-full relative">
      ...
      <div className="grid w-full grid-cols-1 lg:grid-cols-2 mt-5 lg:mt-10 gap-3 lg:gap-5">
        {CoreValuesData.map((item, index) => (
          <div
            key={index}
            className="cursor-pointer bg-zinc-100 flex justify-start  items-center px-5 py-5 lg:py-10 rounded-lg relative"
