...
const Ctaform2 = ({ closeDropdown }: { closeDropdown: () => void }) => {
    return (
      <main className="bg-white rounded-2xl z-[999]  md:p-10 p-6 absolute left-1/2 -translate-x-1/2 top-1/2  -translate-y-1/2  lg:w-[50em]  mx-auto">
