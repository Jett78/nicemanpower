  ...
  return (
    <div className="w-full lg:pt-[6rem]  overflow-hidden flex justify-center items-center">
      <div className="flex flex-col relative gap-4">
        <Link
          to="/jobs"
          className="flex-col absolute hero top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40vw] lg:w-[15vw] h-[40vw] lg:h-[15vw] rounded-full  bg-gradient-to-tr from-green-600 to-green-400 text-white z-10 flex justify-center items-center"
        >
